...
if __name__ == '__main__':
    with pd.option_context('display.max_rows', None, 'display.max_columns', None, 'max_colwidth', 400):
        enhanced_feat_def_df = pd.read_parquet(
            "/kaggle/input/home-credit-enhanced-feature-definitions/feature_definitions_dtypes_tables.parquet")
...
# TypeError: prepare_df() missing 2 required positional arguments: 'data_dir' and 'aggregator'
def prepare_df(
